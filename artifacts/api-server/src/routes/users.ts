...
router.get("/users", requireAdminAuth, async (_req, res): Promise<void> => {
...
router.post("/users", requireAdminAuth, async (req, res): Promise<void> => {
...
router.put("/users/:id", requireAdminAuth, async (req, res): Promise<void> => {
...
router.delete("/users/:id", requireAdminAuth, async (req, res): Promise<void> => {
  const id = Number(req.params["id"]);
